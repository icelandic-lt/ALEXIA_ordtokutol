...
def lemma_output(database, IGC_folder, prop_names):
    ...
    if IGC_folder == "corpora/IGC/":
        with open(f'output/{database}/IGC_lemma.freq', mode='w+') as outputfile:
    ...
    ============================================================
        ...
        with open(f'output/{database}/CC_BY_lemma.freq', mode='w+') as outputfile:
            candidates = {k: v for k, v in sorted(freqdic.items(),
                            key=lambda item: item[1]['freq'], reverse=True)}
            for key, value in candidates.items():
                outputfile.write(key+': '+str(value)+ '\n')
    ...
    ============================================================
        ...
        with open(f'output/{database}/TIC_lemma.freq', mode='w+') as outputfile:
            candidates = {k: v for k, v in sorted(freqdic.items(),
                            key=lambda item: item[1]['freq'], reverse=True)}
            for key, value in candidates.items():
                outputfile.write(key+': '+str(value)+ '\n')
    ...
    ============================================================
        ...
        with open(f'output/{database}/'+namefolder+'_lemma.freq', mode='w+') as outputfile:
            candidates = {k: v for k, v in sorted(freqdic.items(),
                            key=lambda item: item[1]['freq'], reverse=True)}
            for key, value in candidates.items():
                outputfile.write(key+': '+str(value)+ '\n')
